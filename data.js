const CHA = 
{
    ...
    "SHU003": {
        "abilities": [
            ...
            "ONCE PER GAME: gain health back to the amount you had before you ended your last turn, if you do so, you draw the number of cards equalling to the amount of health you gained"
        ],
        "name": "Zhang Fei"
    },
    "SHU004": {
    ...
    "WU007": {
        "abilities": [
            ...
            "Whenever you run out of cards in your hand, you can select up to X number of people to draw a card, where X is the number of cards you had right before you ran out of cards in your hand."
        ],
        "name": "Lu Xun"
    },
    "WU005": {
    ...
    "WU003": {
        "abilities": [
            ...
            "TRANSFORM: At the beginning of your turn, if you have 3 or more cards in your hand than your health, then you lose one health limit and gain the effect below",
    ...
    "WEI012":{
        "name": "Dian Wei",
        "abilities": [
            "Once per turn, you can decrease your heath by one or discard a weapon card to deal one damage to another player within your range of attack."
        ]
    },
    "WU013":{
        "name": "Zhou Tai",
    ...
    "SHU009":{
        "name":"Wei Yan",
        "abilities":[
            "For each damage you deal to players within one distance from you, you can heal by 1 or draw 1 card.",
            "ONCE PER GAME: during your main phase, you can decrease your health by X (you decide), then until the end of the turn, your distance to other players decrease by X, and you can use X+1 'kill's in total during that turn."
        ]
    },
    "SHU008":{
        "name:": "Huang Zhong",
